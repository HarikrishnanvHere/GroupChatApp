...
exports.postAddChat = async (req, res, next) =>{
    try{
        ...
        res.status(201).json({user: currentUser, display: message, data: 'msg added successfully'});
...
exports.getFullChat = async (req, res, next) =>{
    try{
        ...
        res.status(201).json({user: currentUser, display: chats, data: 'chats fetched successfully'});
